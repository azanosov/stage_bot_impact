...
class Contact(Asset):
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Contact":
        first_name = (
            data.get("first_name") or data.get("firstName") or data.get("FirstName")
        )
        last_name = (
            data.get("last_name") or data.get("lastName") or data.get("LastName")
        )
        email = data.get("email") or data.get("Email")
        if first_name is None or last_name is None or email is None:
            raise AssetParseError(
                "Missing required field for Contact: first_name, last_name, or email"
            )
        return cls(
...
class RobotCredential(Asset):
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "RobotCredential":
        ...
        if username is None or password is None:
            raise AssetParseError(
                "Missing required field for RobotCredential: username or password"
            )
        return cls(
            username=username,
            password=password,
...
class UserCredential(Asset):
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "UserCredential":
        ...
        if username is None or password is None:
            raise AssetParseError(
                "Missing required field for UserCredential: username or password"
            )
        return cls(
            username=username,
            password=password,
...
class APICredential(Asset):
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "APICredential":
        ...
        if client_id is None or client_secret is None:
            raise AssetParseError(
                "Missing required field for APICredential: client_id or client_secret"
            )
        return cls(
            client_id=client_id,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "DatabaseCredential":
        try:
            ...
            if (
                ...
                raise AssetParseError(
                    "Missing required field for DatabaseCredential: hostname, database, username, or password"
                )
            return cls(
                hostname=hostname,
...
class SSHCredential(Asset):
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "SSHCredential":
        ...
        if hostname is None or username is None:
            raise AssetParseError(
                "Missing required field for SSHCredential: hostname or username"
            )
        return cls(
            hostname=hostname,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "EmailTemplate":
        try:
            ...
            return cls(
                ...
                bcc=parse_recipients(
                    data.get("bcc") or data.get("Bcc") or data.get("BCC")
                ),
            )
