...
def InitialiseApplications(init_function_name: str = None, init_module_name: str = "rpaprocess") -> dict:
    """
    ...
    try:
        ...
        if init_function_name:
            ...
            logger.info(f"Initialised {len(initialised_apps)} application(s) via function: {list(initialised_apps.keys())}")
