...
def click_element(driver: WebDriver, selector: str, by: str = By.XPATH, timeout: int = 10) :
...
def find_element(driver: WebDriver, selector: str, by: str = By.XPATH, timeout: int = 10):
...
def element_exists(driver: WebDriver, selector: str, by: str = By.XPATH, timeout: int = 10) -> bool:
...
def type_into_element(driver: WebDriver, selector: str, value, by: str = By.XPATH, timeout: int = 10):
