...
def download_payroll_activity_summary_report(
    browser, request: PayrollActivitySummaryRequest
) -> str:
    """
...
def update_and_export_report(browser, request: PayrollActivitySummaryRequest) -> str:
