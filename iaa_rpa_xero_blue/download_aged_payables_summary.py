...
def download_aged_payables_summary_report(
    browser, request: AgedPayablesSummaryRequest
) -> str:
    """
    ...
    Raises:
        ...
        DataExtractionError if the client has no payables data.
    """
...
def update_and_export_report(browser, request: AgedPayablesSummaryRequest) -> str:
    ...
    if not browser.does_page_contain_element(
        ...
        raise DataExtractionError(
            "No Aged Payables Summary data available for this client."
        )
