...
def download_aged_payables_detail_report(browser, request: AgedPayablesRequest) -> str:
    """
...
def update_and_export_report(browser, request: AgedPayablesRequest) -> str:
    ...
    if not browser.does_page_contain_element(
        ...
        logger.warning(
            "Export button not found - no Aged Payables data available for this client"
        )
        raise DataExtractionError(
            "No Aged Payables Detail data available for this client."
        )
