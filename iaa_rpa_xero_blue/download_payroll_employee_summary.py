...
def download_payroll_employee_summary_report(
    browser, request: PayrollEmployeeSummaryRequest
) -> str:
    """
...
def update_and_export_report(browser, request: PayrollEmployeeSummaryRequest) -> str:
